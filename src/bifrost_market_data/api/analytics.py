...
def query_max_pain(
    ...
    *,
    ...
    """Read rows from ``market_analytics.max_pain_daily``."""
    cols = (
        "symbol",
        "trade_date",
        "expiry",
    ...
    _apply_date_filters(
        clauses,
        params,
        table="market_analytics.max_pain_daily",
        symbol_col="symbol",
        sym=sym,
    ...
    sql = f"""
        ...
        FROM market_analytics.max_pain_daily
        {where}
...
def query_atm_iv(
    ...
    *,
    ...
    """Read rows from ``market_analytics.atm_iv_daily``."""
    cols = (
        "symbol",
        "trade_date",
        "expiry",
    ...
    _apply_date_filters(
        clauses,
        params,
        table="market_analytics.atm_iv_daily",
        symbol_col="symbol",
        sym=sym,
        trade_date=trade_date,
        lookback_days=lookback_days,
    ...
    sql = f"""
        ...
        FROM market_analytics.atm_iv_daily
        {where}
        ORDER BY trade_date DESC, symbol ASC, expiry ASC
        LIMIT 500
    """
...
def query_pcr(
    ...
    *,
    ...
    """Read rows from ``market_analytics.pcr_daily``."""
    cols = (
        "symbol",
        "trade_date",
        "pcr_oi",
    ...
    _apply_date_filters(
        clauses,
        params,
        table="market_analytics.pcr_daily",
        symbol_col="symbol",
        sym=sym,
        trade_date=trade_date,
        lookback_days=lookback_days,
    ...
    sql = f"""
        ...
        FROM market_analytics.pcr_daily
        {where}
...
def query_iv_percentile(
    ...
    *,
    ...
    """Read rows from ``market_analytics.iv_percentile_daily``."""
    cols = (
        "symbol",
        "trade_date",
        "iv_current",
    ...
    _apply_date_filters(
        clauses,
        params,
        table="market_analytics.iv_percentile_daily",
        symbol_col="symbol",
        sym=sym,
        trade_date=trade_date,
        lookback_days=lookback_days,
    ...
    sql = f"""
        ...
        FROM market_analytics.iv_percentile_daily
        {where}
        ORDER BY trade_date DESC, symbol ASC
        LIMIT 500
    """
...
def atm_iv_term(
    ...
    return {
        ...
        "source": "market_analytics.atm_iv_daily",
    }
